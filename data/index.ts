...
export const gridItems = [
  {
    id: 1,
    title: "Facilitating client collaboration through open and transparent communication.",
    description: "",
  ...
  },
  {
    id: 3,
    title: "My tech stack",
    description: "Modern Web Developement",
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 4,
    title: "Tech aficionado driven by a passion for development.",
    description: "",
  ...
  {
    id: 5,
    title: "Currently building a Secret Project",
    description: "Unveiling Insights",
...
export const testimonials = [
  {
    quote:
      "Collaborating with Sumit Jhadiyal was an absolute pleasure. His professionalism, promptness, and dedication to delivering exceptional results were evident throughout our project. Sumit Jhadiyal's enthusiasm for every facet of development truly stands out. If you're seeking to elevate your website and elevate your brand, Sumit Jhadiyal is the ideal partner.",
